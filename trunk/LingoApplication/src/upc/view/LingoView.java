...
public class LingoView extends FrameView {
    ...
    @Action
    public void openDialogManageUnidad() {
        if (dialogManageUnidad == null) {
            dialogManageUnidad = new DialogManageUnidad(mainFrame, true);
            dialogManageUnidad.setLocationRelativeTo(mainFrame);
        }
        LingoApplication.getApplication().setActualView(dialogManageUnidad);
        LingoApplication.getApplication().show(dialogManageUnidad);
    }

    @Action
    public void openDialogShowReport() {
        if (dialogShowReport == null) {
            dialogShowReport = new DialogShowReport(mainFrame, true);
            dialogShowReport.setLocationRelativeTo(mainFrame);
        }
        LingoApplication.getApplication().setActualView(dialogShowReport);
    ...
    public void openDialogAbout() {
        ...
        LingoApplication.getApplication().setActualView(aboutBox);
    ...
    private void initComponents() {
        ...
        jMenuItem3.setAction(actionMap.get("openDialogManageUnidad")); // NOI18N
        jMenuItem3.setIcon(resourceMap.getIcon("jMenuItem3.icon")); // NOI18N
        jMenuItem3.setText(resourceMap.getString("jMenuItem3.text")); // NOI18N
        jMenuItem3.setName("jMenuItem3"); // NOI18N
        fileMenu.add(jMenuItem3);

        jMenuItem1.setAction(actionMap.get("openDialogShowReport")); // NOI18N
        ...
        aboutMenuItem.setAction(actionMap.get("openDialogAbout")); // NOI18N
    ...
    private LingoAboutBox aboutBox;
    private DialogShowReport dialogShowReport;
    private DialogManageUnidad dialogManageUnidad;
}
